			...
			<table border="1" bordercolor="#dedede">
				...
				<c:forEach var="memo" items="${list}">
     			<tr>
     				...
     				<td>${memo.memo}</td> 
     				<td>${memo.place}</td> 
					<td><a href="servlet/EditMemoServlet?memoid=${memo.memoid}">编辑</a></td>
					<td><a href="servlet/DeleteMemoServlet?memoid=${memo.memoid}">删除</a></td>
     			</tr>
				</c:forEach>
         		<tr>
         			<td colspan="7" width="200px" height="50px" align="center">
         				<a href="addmemo.jsp"><input style="height: 35px;width: 70px" type="submit" name="Submit" value="添加" /></a>
         			</td>
         		</tr>
         	</table>
         </div>
