...
<html>
  <head>
    ...
    <body>
        ...
        <div class="noshadow">
        <%List<Expense> list=(List<Expense>) request.getAttribute("elist"); %>
         <form name="" action="servlet/EditExpenseDatabaseServlet" method="post">
         	<input type="hidden" name="incomeid" value="<%=list.get(0).getExpenseid()%>">
